...
export default function UserModal({ isOpen, onClose, user, roles, onSave }: UserModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="bg-[#0F172A] border border-[#334155] rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2 mb-2">
                                ...
                                <button
                                    ...
                                    className="px-3 py-2 bg-blue-600/20 text-blue-400 rounded-lg hover:bg-blue-600/30 text-sm font-medium"
                                >
                                    Add
                                </button>
                            </div>
                ...
                <div className="px-6 py-5 border-t border-[#334155] bg-[#1E293B]/50 flex justify-end gap-3">
                    ...
                    <button onClick={handleSave} className="px-6 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-500 rounded-xl shadow-lg shadow-blue-900/20 transition-all">Save Changes</button>
                </div>
            </div>
        </div>
    );
